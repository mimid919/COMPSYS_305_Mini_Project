...
BEGIN
    ...
    red   <= sprite_rgb(11 DOWNTO 8) when (inside = '1' and sprite_rgb(11 downto 8) /= "0010") else "0000";
    green <= sprite_rgb(7 DOWNTO 4) when (inside = '1' and sprite_rgb(11 downto 8) /= "1111") else "0000";
    blue  <= sprite_rgb(3 DOWNTO 0) when (inside = '1' and sprite_rgb(11 downto 8) /= "0000") else "0000";
